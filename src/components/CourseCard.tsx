	...
	return (
		<Card className="group relative h-full min-h-[320px] sm:min-h-[340px] md:min-h-[360px] lg:min-h-[380px] border-white/10 bg-gradient-to-br from-white/8 via-cyan-500/5 to-blue-500/8 backdrop-blur-sm transition-all duration-200 ease-out hover:border-cyan-400/30 hover:bg-gradient-to-br hover:from-white/12 hover:via-cyan-500/10 hover:to-blue-500/12 cursor-pointer hover:shadow-xl hover:shadow-cyan-500/15 hover:-translate-y-1 hover:scale-[1.01] before:absolute before:inset-0 before:rounded-lg before:bg-gradient-to-r before:from-transparent before:via-cyan-500/10 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-200 before:ease-out">
			...
			<div className="flex h-full flex-col">
				<CardHeader className="space-y-3 sm:space-y-3 p-4 sm:p-4 md:p-6 flex-shrink-0">
					{/* Category & Rating */}
					...
					{/* Title */}
					<h3 className="text-base sm:text-lg md:text-xl font-bold text-white leading-tight group-hover:text-orange-100 transition-colors duration-200 ease-out line-clamp-2 min-h-[2.5rem] sm:min-h-[3rem] md:min-h-[3.5rem]">
						{course.title}
					</h3>
				...
				{/* Metadata */}
				<div className="grid grid-cols-3 gap-2 sm:gap-2 md:gap-3 pt-2 sm:pt-2 flex-shrink-0">
				...
				<CardFooter className="pt-4 sm:pt-4 md:pt-6 p-4 sm:p-4 md:p-6 flex-shrink-0 mt-auto">
					<Button 
						asChild 
						className="w-full bg-[#00ffff] text-black font-semibold hover:bg-[#00e6e6] transition-all duration-200 ease-out shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 ripple-effect btn-enhanced text-sm sm:text-sm md:text-base h-10 sm:h-10 md:h-11"
					>
